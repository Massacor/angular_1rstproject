...
MyFirstApp.controller('usersCtrl', function($scope, $http, $rootScope) {
	$http({
		method:'GET',
...
MyFirstApp.controller('depensesCtrl', function($scope, $http, $rootScope) {
	...
	$http({
		...
		console.log($scope.aConcernesFinal)
	});
});